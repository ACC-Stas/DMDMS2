CREATE OR REPLACE PACKAGE LAB4 AS
    ...
    FUNCTION PARSE_DELETE(XML_STRING IN VARCHAR2) RETURN VARCHAR2;
    FUNCTION PARSE_CREATE(XML_STRING IN VARCHAR2) RETURN VARCHAR2;
    FUNCTION PARSE_DROP(XML_STRING IN VARCHAR2) RETURN VARCHAR2;
